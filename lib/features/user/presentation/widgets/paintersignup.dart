...
//   BackgroundPainter2({Animation<double>animation})
//       : blue1Paint = Paint()
//     ..color = QureosColors.darkBlue
//     ..style = PaintingStyle.fill,
//         blue2Paint = Paint()
//           ..color = QureosColors.blueAccent
//           ..style = PaintingStyle.fill,
//         blue3Paint = Paint()
//           ..color = QureosColors.whiteBlue
//           ..style = PaintingStyle.fill,
//
...
//         Point(
//           size.width / 4,
//           lerpDouble(size.height / 4, size.height /3, liquidAnim.value),
//         ),
//         Point(
//           size.width * 3 / 5,
...
//         Point(
//           size.width * 4 / 5,
//           lerpDouble(size.height / 7, size.height / 4, blue2Anim.value),
//         ),
//         Point(
//           size.width,
